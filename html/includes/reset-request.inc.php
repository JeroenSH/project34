...
if (isset($_POST["reset-request-submit"])) {
  ...
  $url = "localhost/MyWebsite" . $selector . "&validator=" . bin2hex($token);///create-new-password.php?selector=*
  ...
  $headers = "From: mmtuts <glenncapelle@gmail.com>\r\n";
  $headers .= "Reply-To: glenncapelle@gmail.com\r\n";
