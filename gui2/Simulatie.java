...
public class Simulatie extends JPanel implements ActionListener{
    ...
    public void settings(Bon bon) {
        ...
        ImageIcon icon10 = new ImageIcon(new ImageIcon("src\\tieneuro.jpg").getImage().getScaledInstance(400, 200, Image.SCALE_DEFAULT));
        tienimage = new JLabel(icon10, JLabel.CENTER);
        tienimage.setPreferredSize(imagepreferredSize);

        ImageIcon icon20 = new ImageIcon(new ImageIcon("src\\twintigeuro.jpg").getImage().getScaledInstance(400, 200, Image.SCALE_DEFAULT));;
        twintigimage = new JLabel(icon20, JLabel.CENTER);
        twintigimage.setPreferredSize(imagepreferredSize);

        ImageIcon icon50 = new ImageIcon(new ImageIcon("src\\vijftigeuro.jpg").getImage().getScaledInstance(400, 200, Image.SCALE_DEFAULT));;
